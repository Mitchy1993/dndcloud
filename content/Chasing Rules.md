...
## Dash Limits
- A creature can Dash a number of times equal to 3 + its Constitution modifier.
- Each Dash beyond this limit requires a DC 10 Constitution check. On a failure, the creature gains one level of exhaustion.
## Complications
- At the end of each participant's turn, roll a d20 to determine if a complication arises.
...
| 19-20    | **Watch Patrol**: Make a DC 10 Charisma (Deception) or Dexterity (Stealth) check to evade the city watch. On a failure, you are delayed for 1 round.              |
...
| 19-20    | **Swarm of Insects**: Make a DC 10 Dexterity (Acrobatics) check to avoid bites. On a failure, take 1d4 poison damage.                                             |
...
| 19-20    | **Rats**: Make a DC 10 Dexterity (Acrobatics) check to avoid them. On a failure, take 1d4 piercing damage from bites.                                            |
